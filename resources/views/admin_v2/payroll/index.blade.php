...
<style>
:root{--bg:#e9eef6;--panel:#f3f6fb;--card:#fff;--line:#c9d6ea;--line-soft:#dde6f4;--text:#1f2f46;--muted:#5f7087;--primary:#1f4f8f;--danger-soft:#ffeded;--danger-line:#f4c6c6;--danger-text:#c15353}
*{box-sizing:border-box}body{margin:0;font-family:"Segoe UI","Hiragino Kaku Gothic ProN",Meiryo,sans-serif;background:var(--bg);color:var(--text)}
.wrap{width:min(1500px,98vw);margin:4px auto}.head{display:flex;justify-content:space-between;align-items:center;gap:8px;margin-bottom:4px}.head-title{margin:0;font-size:34px;font-weight:900;color:#1a4f93;line-height:1}.head-nav{display:flex;gap:10px;flex-wrap:wrap}
.btn{display:inline-flex;align-items:center;justify-content:center;min-height:34px;padding:0 12px;border:1px solid var(--line);border-radius:12px;background:#fff;color:var(--text);text-decoration:none;font-weight:700;cursor:pointer}.btn.primary{background:var(--primary);border-color:var(--primary);color:#fff}
.panel{background:var(--panel);border:1px solid var(--line);border-radius:14px;padding:6px}.filters{display:flex;flex-wrap:wrap;align-items:center;gap:8px;margin-bottom:4px}.filters label{font-weight:700;color:var(--muted)}
select,input[type="month"]{height:34px;border:1px solid var(--line);border-radius:10px;background:#fff;padding:0 10px;min-width:128px}.count{font-size:13px;color:var(--muted);margin-bottom:4px}
.panel > .content{display:grid;grid-template-columns:260px minmax(0,1fr);gap:6px;min-height:0;align-items:start}
.panel > .content > .staff-list{grid-column:1;grid-row:1;background:#eef3fa;border:1px solid var(--line);border-radius:12px;padding:6px;overflow:auto;max-height:78vh;min-width:0}
.panel > .content > .main{grid-column:2;grid-row:1;min-width:0}
.staff-item{display:block;text-decoration:none;color:inherit;border:1px solid var(--danger-line);background:#fff;border-radius:10px;padding:6px;margin-bottom:6px}.staff-item.active{background:var(--danger-soft);box-shadow:inset 0 0 0 1px #efb6b6}
.staff-name{font-size:16px;font-weight:700;margin:0 0 4px;line-height:1.15}.staff-meta{display:flex;align-items:center;gap:6px;flex-wrap:wrap;font-size:14px;color:#334663}.pill{display:inline-block;padding:2px 8px;border-radius:999px;background:#ffeaea;color:var(--danger-text);font-size:12px;font-weight:700}
.main{display:grid;grid-template-rows:auto auto auto;gap:6px}.top-cards{display:grid;grid-template-columns:repeat(5,minmax(140px,1fr));gap:6px}
.card{background:var(--card);border:1px solid var(--line);border-radius:12px;padding:6px}.card .k{font-size:11px;color:var(--muted);margin-bottom:3px;font-weight:700}.card .v{font-size:18px;font-weight:800;line-height:1.1;color:#0f294a;word-break:break-word}.top-cards .card .v{font-size:18px;font-weight:800;line-height:1.1;color:#0f294a;word-break:break-word}.name-value{font-size:15px!important;}
.actions{display:flex;gap:6px;flex-wrap:wrap}
.sections{display:grid;grid-template-columns:1.2fr 1.2fr 1.2fr 1fr 1fr;gap:6px;align-items:start}.sections > div{min-width:0}.section-title{margin:0 0 4px;font-size:15px;color:#173f72}
.kv{width:100%;border-collapse:collapse;font-size:14px}.kv td{border-top:1px solid var(--line-soft);padding:4px 6px;line-height:1.15}.kv td:last-child{text-align:right;font-variant-numeric:tabular-nums;font-weight:700}.kv tr.total-row td{background:#eef5ff;color:#1f4f8f;font-weight:800}.kv .memo-wrap{padding:4px 2px 6px}.kv .memo-wrap .memo-label{font-weight:700;color:#5f6775;margin-bottom:3px;text-align:left}.kv .memo-wrap .memo-value{background:#fff;border:1px solid var(--line);border-radius:6px;min-height:88px;max-height:128px;padding:8px 6px;text-align:left;white-space:pre-wrap;word-break:break-word;font-weight:500;line-height:1.35;overflow:auto}
.totals{display:grid;grid-template-columns:repeat(4,1fr);gap:6px}.total-card{background:var(--card);border:1px solid var(--line);border-radius:12px;padding:6px}.total-card .k{font-size:11px;color:var(--muted);font-weight:700;margin-bottom:2px}.total-card .v{font-size:24px;font-weight:900;text-align:right;color:#1a4d8e;line-height:1;font-variant-numeric:tabular-nums}
.empty{padding:24px;text-align:center;color:var(--muted);background:var(--card);border:1px dashed var(--line);border-radius:12px}.readonly-card{background:#eef1f5;border-color:#d8dee8}.readonly-card .section-title,.readonly-card .k,.readonly-card td{color:#5f6775}.edit-input{width:120px;max-width:100%;height:26px;border:1px solid var(--line);border-radius:6px;padding:0 6px;text-align:right;font-variant-numeric:tabular-nums;background:#fff;color:#1f2f46}.edit-input.text{text-align:left}.edit-only{display:none}.is-editing .edit-only{display:inline-block}.is-editing .view-only{display:none}
@media (max-width:980px){.panel > .content{grid-template-columns:1fr !important}.panel > .content > .staff-list{max-height:300px;height:auto;min-height:0}.top-cards{display:grid;grid-template-columns:repeat(5,minmax(140px,1fr));gap:6px}.sections{grid-template-columns:1fr}.totals{grid-template-columns:repeat(2,1fr)}}
</style>
</head>
<body>
@php
...
'adjustment_year_end'=>'&#24180;&#26411;&#35519;&#25972;','koujyo_1'=>'&#23450;&#38989;&#28187;&#31246;&#38989;','cost_liquidation'=>'&#31435;&#26367;&#28165;&#31639;','company_advance_cost'=>'&#20250;&#31038;&#31435;&#26367;&#36027;&#29992;','fuyo_sum'=>'&#25206;&#39178;&#20154;&#25968;','work_kiso_num'=>'&#20986;&#21220;&#22522;&#30990;&#26085;&#25968;','tax_table'=>'&#31246;&#38989;&#34920;','set_work_time'=>'&#25152;&#23450;&#21172;&#20685;&#26178;&#38291;(&#26085;)','month_set_work_time'=>'&#25152;&#23450;&#21172;&#20685;&#26178;&#38291;(&#26376;)','day_set_work_time'=>'&#25152;&#23450;&#21172;&#20685;&#26178;&#38291;(&#36913;)','yukyu_month'=>'&#26377;&#20241;&#21152;&#31639;&#26376;','social_join'=>'&#31038;&#20445;&#21152;&#20837;','employment_join'=>'&#38599;&#20445;&#21152;&#20837;','memo'=>'&#12513;&#12514;','kyuyo_memo'=>'&#26126;&#32048;&#20633;&#32771;',
'hourly_wage'=>'&#26178;&#32102;','hourly_wage_adjusted'=>'&#26178;&#32102;(&#35519;&#25972;&#24460;)','monthly_salary'=>'&#26376;&#32102;','hourly_pay'=>'&#26178;&#32102;','hourly_salary'=>'&#26178;&#32102;(&#35519;&#25972;&#24460;)','executive_remu'=>'&#24441;&#21729;&#22577;&#37228;','position_allow'=>'&#24441;&#32887;&#25163;&#24403;','duties_allow'=>'&#32887;&#21209;&#25163;&#24403;','qualification_allow'=>'&#36039;&#26684;&#25163;&#24403;','claim_allow'=>'&#35531;&#27714;&#25163;&#24403;','traffic_pay'=>'&#35506;&#31246;&#36890;&#21220;&#36027;','adjustment_add'=>'&#35519;&#25972;&#25163;&#24403;','rent_subsidies'=>'&#23478;&#26063;&#25163;&#24403;','rent_pay'=>'&#38750;&#35506;&#31246;&#36890;&#21220;&#36027;','adjustment_pay'=>'&#27424;&#21220;&#25511;&#38500;','fixed_overtime'=>'&#22266;&#23450;&#27531;&#26989;&#25163;&#24403;','kotei_sum'=>'&#22266;&#23450;&#21512;&#35336;','yakuin_sum'=>'&#24441;&#21729;&#21512;&#35336;','not_syaho'=>'&#31038;&#20445;&#23550;&#35937;&#22806;','not_rouho'=>'&#21172;&#20445;&#23550;&#35937;&#22806;','not_supply'=>'&#25903;&#32102;&#23550;&#35937;&#22806;','rouho_target_sum'=>'&#21172;&#20445;&#23550;&#35937;&#21512;&#35336;','syaho_target_sum'=>'&#31038;&#20445;&#23550;&#35937;&#21512;&#35336;','kenpo_monthly_amo'=>'&#20581;&#20445;&#27161;&#28310;&#22577;&#37228;&#26376;&#38989;','kounen_monthly_amo'=>'&#21402;&#24180;&#27161;&#28310;&#22577;&#37228;&#26376;&#38989;','kenpo_toukyu'=>'&#20581;&#20445;&#31561;&#32026;','kounen_toukyu'=>'&#21402;&#24180;&#31561;&#32026;',
];
...
$supplySum=is_numeric($summary['supply_sum']??null)?(float)$summary['supply_sum']:0.0; $deductionSum=is_numeric($summary['deduction_sum']??null)?(float)$summary['deduction_sum']:0.0; $otherSum=is_numeric($summary['adjustment_year_end']??null)?(float)$summary['adjustment_year_end']:0.0; $netPay=$supplySum-$deductionSum;
$salesCoreTotal = 0.0;
...
$supply=['&#25903;&#32102;' => []];
$mid=['&#25511;&#38500;' => [['kenpo',0],['kaigo',0],['kounen',0],['koyou',0],['syaho_sum',0],['income_tax',0],['resident_tax',0],['rent_cost',0],['adjustment_cost',0],['koujyo_1',0],['deduction_sum',0],['koyou_office',0],['jidou_office',0],['rousai_office',0]],'&#12381;&#12398;&#20182;' => [['adjustment_year_end',0],['cost_liquidation',0],['company_advance_cost',0],['kyuyo_memo',-1]]];
$baseInfoTitle = '&#22522;&#26412;&#24773;&#22577;';
$referenceTitle = '&#21442;&#32771;&#38598;&#35336;';
$masterTitle = '&#32102;&#19982;&#12510;&#12473;&#12479;';
$shahoTitle = '&#31038;&#20250;&#20445;&#38522;';
...
$rightA=[
    $baseInfoTitle => [['fuyo_sum',0],['tax_table',-1],['set_work_time',2],['day_set_work_time',2],['month_set_work_time',0],['yukyu_month',0],['social_join',0],['employment_join',0],['memo',-1]],
...
<div class="content" style="display:grid;grid-template-columns:260px minmax(0,1fr);gap:6px;align-items:start;">
@include('admin_v2.payroll.partials.staff_list')
<main class="main" id="payroll-main" style="min-width:0;">@if ($selectedRow)
...
<div class="sections" style="display:flex;flex-wrap:nowrap;gap:6px;align-items:flex-start;">
  <div style="flex:1.2 1 0;min-width:0;display:grid;gap:8px;">
    @include('admin_v2.payroll.partials.sections_left')
  </div>
  <div style="flex:1.2 1 0;min-width:0;display:grid;gap:8px;">
    @include('admin_v2.payroll.partials.sections_supply')
  </div>
  <div style="flex:1.2 1 0;min-width:0;display:grid;gap:8px;">
    @include('admin_v2.payroll.partials.sections_mid')
  </div>
  <div style="flex:1 1 0;min-width:0;display:grid;gap:8px;">
    @include('admin_v2.payroll.partials.sections_right_a')
  </div>
  <div style="flex:1 1 0;min-width:0;display:grid;gap:8px;">
    @include('admin_v2.payroll.partials.sections_right_b')
  </div>
</div>
@else <div class="empty">Select staff.</div> @endif
<div class="totals"><section class="total-card"><div class="k">&#25903;&#32102;&#38989;</div><div class="v">{{ number_format($supplySum, 0) }}</div></section><section class="total-card"><div class="k">&#25511;&#38500;&#21512;&#35336;</div><div class="v">{{ number_format($deductionSum, 0) }}</div></section><section class="total-card"><div class="k">&#12381;&#12398;&#20182;&#21512;&#35336;</div><div class="v">{{ number_format($otherSum, 0) }}</div></section><section class="total-card"><div class="k">&#24046;&#24341;&#25903;&#32102;&#38989;</div><div class="v">{{ number_format($netPay, 0) }}</div></section></div>
</main></div></section>
</div>
<script>
(function(){
