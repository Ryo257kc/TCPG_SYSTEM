  ...
  @else
    @foreach ($groupedCompanies as $company)
      @php
        ...
        $rowDefs = array_merge(
            [
                ['label' => '部署区分', 'key' => 'division', 'type' => 'text', 'sum' => false],
                ['label' => '出勤日数', 'key' => 'work_in_num', 'type' => 'num', 'digits' => 0, 'sum' => true],
                ['label' => '所定内時間', 'key' => 'work_time', 'type' => 'num', 'digits' => 2, 'sum' => true],
                ...
                ['label' => '法定休日数', 'key' => 'holiday_true_num', 'type' => 'num', 'digits' => 0, 'sum' => false],
                ['label' => '法定休日時数', 'key' => 'holiday_true', 'type' => 'num', 'digits' => 2, 'sum' => true],
                ['label' => '遅刻・早退時間', 'key' => 'late_time', 'type' => 'num', 'digits' => 2, 'sum' => true],
                ['label' => '賞与', 'key' => 'bonus_amount', 'type' => 'money', 'sum' => true],
            ...
            [
                ...
                ['label' => '健康保険標準報酬月額', 'key' => 'kenpo_monthly_amo', 'type' => 'money', 'sum' => true],
                ['label' => '厚生年金標準報酬月額', 'key' => 'kounen_monthly_amo', 'type' => 'money', 'sum' => true],
            ]
        );
