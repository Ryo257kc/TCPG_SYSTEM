...
<div class="company-detail-form company-tab-readonly">
  <div class="detail-grid">
    ...
    <label class="detail-field">
      <span>労災保険番号</span>
      <div class="detail-value {{ $selectedRow['labor_insurance_number'] === '' ? 'detail-value-empty' : '' }}">{{ $selectedRow['labor_insurance_number'] !== '' ? $selectedRow['labor_insurance_number'] : '---' }}</div>
    </label>

    <label class="detail-field">
      <span>労保適用区分</span>
      <div class="detail-value {{ $selectedRow['labor_install_category'] === '' ? 'detail-value-empty' : '' }}">{{ $selectedRow['labor_install_category'] !== '' ? $selectedRow['labor_install_category'] : '---' }}</div>
    </label>
    <label class="detail-field">
      <span>労保設置日</span>
      <div class="detail-value {{ $selectedRow['labor_install_date'] === '' ? 'detail-value-empty' : '' }}">{{ $selectedRow['labor_install_date'] !== '' ? $selectedRow['labor_install_date'] : '---' }}</div>
    </label>

    <label class="detail-field">
      <span>労働局区分</span>
      <div class="detail-value {{ $selectedRow['labor_office_category'] === '' ? 'detail-value-empty' : '' }}">{{ $selectedRow['labor_office_category'] !== '' ? $selectedRow['labor_office_category'] : '---' }}</div>
    </label>
    <label class="detail-field">
      <span>労災業種区分</span>
      <div class="detail-value {{ $selectedRow['labor_industry_category'] === '' ? 'detail-value-empty' : '' }}">{{ $selectedRow['labor_industry_category'] !== '' ? $selectedRow['labor_industry_category'] : '---' }}</div>
    </label>
  </div>
