<script>
    ...
    function syncReceiptCsvImportFields() {
        var monthInput = document.getElementById('insurance-csv-sejutsu-month');
        var storeInput = document.getElementById('insurance-csv-store-name');

        if (monthInput) {
            monthInput.value = getReceiptToolbarMonth();
        }

        if (storeInput) {
            storeInput.value = getReceiptToolbarStore();
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var fileInput = document.getElementById('insurance-csv-file');
        var form = document.getElementById('insurance-csv-import-form');
        var statusBox = document.getElementById('insurance-csv-import-status');
        ...
        fileInput.addEventListener('change', function() {
            ...
            syncReceiptCsvImportFields();

            var month = getReceiptToolbarMonth();
            var store = getReceiptToolbarStore();
            var targetLabel = month ? month + '月分' : '選択中';
            var message = targetLabel + (store ? '（' + store + '）' : '') + 'のCSVを取込します。\nよろしいですか？';
