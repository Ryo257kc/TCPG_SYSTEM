...
<main class="container">
    ...
    <section class="panel dashboard-office-panel">
        @php
            $receiptLinks = [
                ['label' => 'レセ請求入力', 'sub' => 'レセプト請求入力', 'route' => 'office.receipt.entry'],
                ['label' => '入金確認一覧', 'sub' => '入金確認の一覧'],
                ['label' => '往診窓口一覧', 'sub' => '往診窓口の一覧'],
                ['label' => '保険者一覧', 'sub' => '保険者の一覧', 'route' => 'office.insurers'],
                ['label' => '月次処理', 'sub' => 'レセプト月次処理'],
            ];
        @endphp
