...
<main class="container">
    ...
    <section class="panel content-panel">
                ...
                <table class="data-table">
                    ...
                    @foreach ($rows as $row)
                        <tr>
                            ...
                            <td class="num">{{ number_format($row['insurance_share']) }}</td>
                            <td>{{ number_format($row['private_count']) }}</td>
                            <td class="num">{{ number_format($row['private_total']) }}</td>
                            <td class="num">{{ number_format($row['private_share']) }}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <td></td>
                        ...
                        <td class="num"><b>{{ number_format($totals['insurance_share']) }}</b></td>
                        <td><b>{{ number_format($totals['private_count']) }}</b></td>
                        <td class="num"><b>{{ number_format($totals['private_total']) }}</b></td>
                        <td class="num"><b>{{ number_format($totals['private_share']) }}</b></td>
                    </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="back-row">
            <a class="btn" href="{{ route('admin.sales') }}">売上MENUへ戻る</a>
        </div>
    </section>
