...
<main class="container">
    ...
    <section class="panel content-panel">
                    ...
                    <div class="action-buttons">
                        ...
                        @if (!empty($canAdminRemand))
                            <form id="remand-form" method="post" action="{{ route('admin.attendance.manage.remand', ['staffId' => $targetStaffId, 'month' => $selectedMonth]) }}">
                                @csrf
                                <button type="submit" class="btn-remand">差戻し</button>
                            </form>
                        @endif
                    </div>
                @elseif (!empty($adminApprovedAt))
                    <div class="approved-text">{{ $adminApprovedAt }} 管理者承認済</div>
                @endif
            </div>
        @endif
        ...
        <div class="back-row">
            <a class="btn btn-back" href="{{ route('attendance.management', ['month' => $selectedMonth]) }}">戻る</a>
        </div>
    </section>
</main>
</body>
