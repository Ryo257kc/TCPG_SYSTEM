...
<body class="documents-index-page">
    <main class="container">
        ...
        <style>
            ...
            .documents-index-page th,
            .documents-index-page td {
            ...
            .documents-index-page thead th {
                background: #fff4e8;
                text-align: center;
            }

            .documents-index-page .num {
                width: 48px;
                text-align: center;
                white-space: nowrap;
            }

            .documents-index-page .note {
                text-align: center;
                color: var(--sub);
                font-weight: 700;
                line-height: 1.7;
            ...
            <div class="table-wrap">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th class="num">6</th>
                            <td>運転免許証（通勤や往診で車利用する場合は必須）</td>
                        </tr>
                        <tr>
                            <th class="num">7</th>
                            <td>住民票（運転免許証なし or 運転免許証の住所が違う場合）</td>
                        </tr>
                        <tr>
                            <th class="num">8</th>
                            <td>マイナンバー（住民票記載でも可）</td>
                        </tr>
                        <tr>
                            <th class="num">9</th>
                            <td>振込口座</td>
