...
;WITH source_rows AS (
    ...
    FROM (VALUES
        ...
        (N't_syaho',      N'mx_syaho',      N'kenpo_kyuyo',        N'kenpo_kyuyo',        CAST(NULL AS NVARCHAR(255)), CAST(1 AS BIT)),
        ...
        (N't_syaho',      N'mx_syaho',      N'kaigo_kyuyo',        N'kaigo_kyuyo',        CAST(NULL AS NVARCHAR(255)), CAST(1 AS BIT)),
        ...
        (N't_syaho',      N'mx_syaho',      N'kou_kyuyo',          N'kou_kyuyo',          CAST(NULL AS NVARCHAR(255)), CAST(1 AS BIT)),
        ...
        (N't_syaho',      N'mx_syaho',      N'jidou_kyuyo',        N'jidou_kyuyo',        CAST(NULL AS NVARCHAR(255)), CAST(1 AS BIT)),
