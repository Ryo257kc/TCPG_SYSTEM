    ...
    public function attendancePunch(Request $request): RedirectResponse|View
    {
        ...
        $card = DB::connection('sqlsrv')
            ...
            ->selectRaw("
                ...
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.actual_start, 120), ''))) as actual_start,
    ...
    public function managementDetail(Request $request, string $staffId): RedirectResponse|View
    {
        ...
        $rows = DB::connection('sqlsrv')
            ...
            ->selectRaw("
                ...
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.actual_start, 120), ''))) as jitu_sigyo,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.actual_leave, 120), ''))) as jitu_taisitu,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.actual_break_out, 120), ''))) as jitu_irisitu,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.actual_end, 120), ''))) as jitu_syugyo,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.shift_start, 120), ''))) as shift_sigyo,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.shift_leave, 120), ''))) as shift_taisitu,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.shift_break_out, 120), ''))) as shift_irisitu,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.shift_end, 120), ''))) as shift_syugyo,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.change_start, 120), ''))) as change_sigyo,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.change_leave, 120), ''))) as change_taisitu,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.change_break_out, 120), ''))) as change_irisitu,
                LTRIM(RTRIM(COALESCE(CONVERT(nvarchar(30), tc.change_end, 120), ''))) as change_syugyo,
