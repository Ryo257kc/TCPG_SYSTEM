...
Route::prefix('admin')->group(function (): void {
    ...
    Route::middleware('admin.auth')->group(function (): void {
        ...
        Route::get('/year-end-adjustments/{applicationId}/hoken/{hokenNo}/certificate-xslt-preview', [YearEndAdjustmentV2Controller::class, 'hokenCertificateXsltPreview'])->whereNumber('applicationId')->whereNumber('hokenNo')->name('admin.work.year_end_adjustments.hoken.certificate_xslt_preview');
